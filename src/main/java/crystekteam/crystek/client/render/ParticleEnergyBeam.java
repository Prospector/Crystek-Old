...
public class ParticleEnergyBeam extends Particle {
    ...
    public ParticleEnergyBeam(World par1World, double x, double y, double z, double tx, double ty, double tz, float red, float green, float blue, int age) {
    ...
    @Override
    public void renderParticle(VertexBuffer vertexBuffer, Entity entityIn, float f, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
//        Tessellator tessellator = VertexBuffer
//        tessellator.draw();
//
//        GL11.glPushMatrix();
//        float var9 = 1.0F;
...
//            vertexBuffer.setBrightness(1200);
//            vertexBuffer.setColorRGBA_F(this.particleRed, this.particleGreen, this.particleBlue, op);
//            vertexBuffer.color(this.particleRed, this.particleGreen, this.particleBlue, op);
//            vertexBuffer.sortVertexData();

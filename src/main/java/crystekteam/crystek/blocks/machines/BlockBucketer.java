 ...
 */
public class BlockBucketer extends BlockBase
{
    public BlockBucketer()
    {
        setUnlocalizedName(ModInfo.MOD_ID.toLowerCase() + ".bucketer");
    }
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            playerIn.openGui(Crystek.instance, GuiHandler.bucketer, world, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }

...
import crystekteam.crystekold.util.CraftingHelper;
...
public class ModRecipes
{
    ...
    static void registerCraftingRecipes()
    {
        ...
        GameRegistry.addRecipe(
                new ShapedOreRecipe(new ItemStack(ModBlocks.accelerator), "owo", "btp", "oco", 'w', "cropWheat", 'p',
                        "cropPotato", 'c', "cropCarrot", 'b', "cropBeetroot", 'o', "ingotObsidian", 't',
                        "crystalTesla"));
